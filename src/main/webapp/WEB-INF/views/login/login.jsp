...
<div class="col-md-4 form-login-style-login" style="padding-bottom: 0.5em">
<div class="style-main-text-on-login-jsp col-md-12" style="border-bottom: solid">Вход</div>
