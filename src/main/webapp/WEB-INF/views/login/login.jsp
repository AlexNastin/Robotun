...
<body>
					...
					<div class="col-md-12" style="margin-bottom: 0em">
						<form id="contact-form" class="form-horizontal" method="post"
							...
							<div class="form-group heightStyleValidation">
								...
								<label
									class="error textStyleValidation textStyleValidationColorWhite"
									generated="true" for="inputEmail3"></label>
							</div>
							<div class="form-group heightStyleValidation">
								<input type="password" class="form-control" id="inputPassword3"
									name="j_password" placeholder="Пароль"
									style="font-family: Arial, FontAwesome"> <label
									class="error textStyleValidation textStyleValidationColorWhite"
									generated="true" for="inputPassword3"></label>
							</div>

							<div class="form-group">
								<div class="checkbox" style="padding-left: 0px">
									<label class="signin-text-color"> <input
										type="checkbox" name="_spring_security_remember_me">Запомнить
										меня
									</label>
								</div>
								<c:if test="${message != null }">
									<div class="messagesValidStyle">${message}</div>
								</c:if>
	...
	<script
		src="<c:url value="/resources/js/validate/jquery.validate.min.js" />">
		
	</script>
	<script src="<c:url value="/resources/js/validate/validation.js" />">
