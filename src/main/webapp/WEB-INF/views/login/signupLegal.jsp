...
<%@include file="/WEB-INF/views/headerwithsearch3.jsp"%>
    ...
    <div class="row row-offcanvas row-offcanvas-left" style="background-color: #3abeb1;">
        ...
        <div class="col-sm-3 col-md-2 sidebar-offcanvas"  id="sidebar" role="navigation">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="<c:url value="/signup/userLegal"/>"><i style='float: left' class="fa fa-check-square-o fa-3x"></i> <p style="padding-top: 4%;">Частное лицо</p></a></li>
