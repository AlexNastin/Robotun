...
<div class="col-md-12" style="text-align:right;"><a class="btn btn-primary button-legal-style-main" ng-href='/jobster.by/moderator/rejectLot?id={{lot.idLot}}'>Модерировать</a></div>
</div>
</div>
</div>
</div>
