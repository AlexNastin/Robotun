...
<a href='<c:url value="/physical/profile/myResponses" />' class="list-group-item background-color-menu-profile active-menu">Мои отклики</a>
...
<script type="text/javascript"
		src="<c:url value="/resources/js/profile/physical/autoloadMyResponses.js" />"></script>
		...
		function loader(){         
			...
			$(".load").fadeIn(500, function () {
							$.ajax({
								url:"/webapp/autoloader/physical/myResponses",
								type:"GET",
								data:{
									//передаем параметры
									offset: offset
