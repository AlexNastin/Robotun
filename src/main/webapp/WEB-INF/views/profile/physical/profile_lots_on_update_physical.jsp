...
<a href='<c:url value="/physical/profile/lotsOnUpdate" />' class="list-group-item background-color-menu-profile active-menu">Замечания по лотам</a>
...
<script type="text/javascript"
		src="<c:url value="/resources/js/profile/physical/autoloadLotsOnUpdate.js" />"></script>
		...
		function loader(){         
			...
			$(".load").fadeIn(500, function () {
							$.ajax({
								url:"/jobster.by/autoloader/physical/lotsOnUpdate",
								type:"GET",
								data:{
									//передаем параметры
									offset: offset
