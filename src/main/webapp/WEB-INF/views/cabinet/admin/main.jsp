...
<body id="subpage">
	...
	<div id="templatemo_wrapper">
		...
		<div id="templatemo_menu" class="ddsmoothmenu">
			<ul>
				<li><a href="<c:url value="/private/admin/main" />"
					class="selected">Пользователи</a></li>
		...
		<div id="templatemo_main">
			...
			<!-- END of sidebar -->
			<div id="content">
				<a href="<c:url value="/private/admin/main/add-user"/>">Добавить
				...
				<table>
					...
					<c:forEach items="${listUsers}" var="user">
						<tr>
							...
							<td><a
								href="<c:url value="/private/admin/main/delete-user?id=${user.idUser}" />">Удалить</a></td>
						</tr>
					</c:forEach>
