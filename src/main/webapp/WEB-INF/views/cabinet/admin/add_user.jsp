...
<title>Admin - Добавить пользователя</title>
...
<body id="subpage">
	...
	<div id="templatemo_wrapper">
		...
		<div id="templatemo_menu" class="ddsmoothmenu">
			<ul>
				<li><a href="<c:url value="/private/admin/main" />">Пользователи</a></li>
		...
		<div id="templatemo_main">
			<div id="sidebar">
				...
				<p>На этой странице Вы можете добавить пользователя.</p>
			</div>
			<!-- END of sidebar -->
			<div id="content">
				<form:form modelAttribute="formAddUser" method="POST">
