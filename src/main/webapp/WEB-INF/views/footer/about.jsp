            ...
            <form role="form">
                <div class="tab-content">
                    <div class="tab-pane active" role="tabpanel" id="step1">
                        <h2>Шаг 1</h2>
                       <h3>Что такое Jobster.by?</h3>
                       <p>Jobster.by - совершенно новый сервис в Беларуси по поиску разовой работы, где любой желающий может как подработать, так и найти тех, кто готов помочь.</p>
                       <p>С сайтом могут работать как физические лица, так и любые компании</p>
