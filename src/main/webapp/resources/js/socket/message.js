...
function printText(json, isICall) {
	if("true" == json) {
	    ...
	    var contentBeforeIsCall = "<div class=\"message-item\" id=\"m16\"><div class=\"message-inner\"><div class=\"message-head clearfix\"><div class=\"avatar pull-left\"><a href=\"/webapp/viewUserProfile?id=" + json.idUser +"\"><img style=\"min-height: 40px; max-height: 40px;\" src=\"/webapp/resources/images/avatar_2x.png\"></a></div><div class=\"user-detail\"><h5 class=\"handle\">" + json.nickname + "</h5>";
