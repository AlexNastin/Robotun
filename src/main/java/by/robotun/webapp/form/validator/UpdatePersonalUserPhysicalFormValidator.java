...
public class UpdatePersonalUserPhysicalFormValidator implements Validator {
	...
	private static Logger LOGGER = Logger.getLogger(UpdatePersonalUserPhysicalFormValidator.class);

	@Override
	public boolean supports(Class<?> arg0) {
		return UpdatePersonalUserPhysicalForm.class.isAssignableFrom(arg0);
	}
