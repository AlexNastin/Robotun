...
public class ValidatorParamConstant {
	public static final String FIELD_FORM_UPDATE_PASSWORD_OLD_PASSWORD = "oldPassword";
	public static final String FIELD_FORM_UPDATE_PASSWORD_NEW_PASSWORD = "password";
	public static final String FIELD_FORM_UPDATE_PASSWORD_CONFIRM_PASSWORD = "confirmPassword";
	
	public static final String FIELD_FORM_ADD_LOT_NAME = "name";
	public static final String FIELD_FORM_ADD_LOT_END_DATE = "endDate";
	public static final String FIELD_FORM_ADD_LOT_DESCRIPTION = "description";
	public static final String FIELD_FORM_ADD_LOT_BUDGET = "budget";
	public static final String FIELD_FORM_ADD_LOT_ID_CATEGORY = "idCategory";
