...
public class UpdatePersonalUserLegalFormValidator implements Validator {
	...
	private static Logger LOGGER = Logger.getLogger(UpdatePersonalUserLegalFormValidator.class);

	@Override
	public boolean supports(Class<?> arg0) {
		return UpdatePersonalUserLegalForm.class.isAssignableFrom(arg0);
	}
